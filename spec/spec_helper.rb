...
RSpec.configure do |config|
  ...
  # This allows you to limit a spec run to individual examples or groups you
  # care about by tagging them with `:focus` metadata. When nothing is tagged
  # with `:focus`, all examples get run. RSpec also provides aliases for `it`,
  ...
  # file. Use the documentation formatter for detailed output, unless a
  # formatter has already been configured (e.g. via a command-line flag).
